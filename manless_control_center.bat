...
echo ================================================================
echo.
call manless\restart_system.bat
goto menu
...
echo ================================================================
echo.
call manless\check_system_status.bat
goto menu
...
echo ================================================================
echo.
call manless\test_connections.bat
goto menu
...
if exist "manless\controller\logs\controller.log" (
    echo 📄 Controller Log: manless\controller\logs\controller.log
    echo    Ukuran: 
    for %%A in ("manless\controller\logs\controller.log") do echo    %%~zA bytes
    echo.
    echo 📋 10 baris terakhir:
    echo ----------------------------------------
    tail -10 "manless\controller\logs\controller.log" 2>nul || echo    (Log kosong atau tidak dapat dibaca)
    echo ----------------------------------------
) else (
...
echo.
echo 💡 Tips:
echo - Gunakan 'notepad manless\controller\logs\controller.log' untuk melihat full log
...
echo ================================================================
echo.
call manless\backup_restore.bat
goto menu
...
echo    - manless\README_SISTEM_TERPUSAT.md
echo    - CARA_MENJALANKAN.md
echo    - manless\DATABASE_SETUP.md
echo.
...
if exist "manless\venv\Scripts\activate.bat" (
    echo ✅ Tersedia
) else (
...
echo    - Controllers: 
if exist "manless\controller\main_gate_in.py" (
    echo ✅ Tersedia
) else (
    echo ❌ Tidak ditemukan
)
echo    - Frontend: 
if exist "manless\frontend\package.json" (
    echo ✅ Tersedia
) else (
    echo ❌ Tidak ditemukan
)
